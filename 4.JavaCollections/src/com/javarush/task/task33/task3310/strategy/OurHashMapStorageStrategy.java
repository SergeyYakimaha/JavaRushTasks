...
public class OurHashMapStorageStrategy extends Entry implements StorageStrategy {
    ...
    public OurHashMapStorageStrategy(int hash, Long key, String value, Entry next) {
